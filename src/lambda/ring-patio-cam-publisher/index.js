...
// ------------------------------------------------------------------
// Pre-flight info
const thingShadowName = 'RingPatioCam';
const lambda_name = 'ring-patio-cam-publisher';
...
const processRequest = function(event, callback) {
    ...
    var thingShadows = awsIot.thingShadow({
        keyPath: 'cert/RingPatioCam.private.key',
        certPath: 'cert/RingPatioCam.cert.pem',
    ...
    thingShadows.on('connect', function() {
        ...
        thingShadows.register(thingShadowName, {}, function() {
            ...
            // 'RingPatioCam' with the latest device state and save the clientToken
